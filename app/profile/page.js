      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-80 shrink-0">
          <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-6 space-y-2 sticky top-28">
            <div className="flex flex-col items-center pb-6 border-b border-slate-50 mb-4">
              ...
              <h3 className="mt-4 text-xl font-black text-slate-800">{user.name}</h3>
            ...
            {sidebarLinks.map((link) => (
              <button
                key={link.id}
                onClick={() => link.href ? window.location.href = link.href : setActiveTab(link.id)}
        ...
        <div className="flex-1 space-y-6">
          <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8 md:p-12">
            <div className="mb-10">
              <h1 className="text-3xl font-black text-slate-900 tracking-tight">Personal Information</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-4 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                  ...
                  <span className="font-bold text-slate-700">{user.email || "Not linked"}</span>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-4 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                  ...
                  <span className="font-bold text-slate-700">+91 {user.mobile}</span>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-4 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                  ...
                  <span className="font-bold text-slate-700 capitalize">{user.role} Account</span>
                </div>
              </div>
            </div>
