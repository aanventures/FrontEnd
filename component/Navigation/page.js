  ...
  return (
    <header
      className={`fixed top-0 w-full z-50 transition-all duration-300 ${
        isScrolled
          ? "py-1  bg-white/80 backdrop-blur-lg border-b border-slate-200/50 shadow-sm"
          : "py-2 bg-transparent"
      }`}
    >
      <div className="max-w-full w-full mx-auto px-4 sm:px-6 lg:px-12">
        <div className="flex items-center justify-between">
          {" "}
          {/* Logo Section */}
          <Link href="/" className="group flex items-center flex-shrink-0">
            <div className="relative w-[220px] h-[100px] overflow-hidden">
              <Image
